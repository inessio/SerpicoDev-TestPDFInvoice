...
import 'jspdf-autotable'
 ...
 const  generateInvoice = (cookiePackage) => {
    ...
    doc.addImage(logoData, 'PNG',30,40, 60, 60)
    doc.text('SerpiCookies',95,55)
    doc.text('Website: www.serpicookies.com',95,75)
    doc.text('Date: ' + new Date().toLocaleString(),95,95)
    doc.text('Client: ' + cookiePackage.clientName, 30, 115)
